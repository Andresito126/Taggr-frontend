...
class MaterialTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      secondary: Color(0xff0a5300),
      onSecondary: Color(0xffffffff),
      secondaryContainer: Color(0xff106e00),
      onSecondaryContainer: Color(0xff93ef79),
      ...
      secondaryFixed: Color(0xff9cf981),
      onSecondaryFixed: Color(0xff022100),
      secondaryFixedDim: Color(0xff81dc68),
      onSecondaryFixedVariant: Color(0xff0a5300),
  ...
  static ColorScheme lightMediumContrastScheme() {
    return const ColorScheme(
      ...
      secondaryFixed: Color(0xff257e14),
  ...
  static ColorScheme darkMediumContrastScheme() {
    return const ColorScheme(
      ...
      secondary: Color(0xff96f27c),
      onSecondary: Color(0xff032d00),
      secondaryContainer: Color(0xff4ca338),
  ...
  static ColorScheme darkHighContrastScheme() {
    return const ColorScheme(
      ...
      secondaryContainer: Color(0xff7dd865),
