...
class MaterialTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      secondary: Color(0xff106e00),
      onSecondary: Color(0xffffffff),
      secondaryContainer: Color(0xff39ff14),
      onSecondaryContainer: Color(0xff107100),
      ...
      secondaryFixed: Color(0xff79ff5b),
      onSecondaryFixed: Color(0xff022100),
      secondaryFixedDim: Color(0xff2ae500),
      onSecondaryFixedVariant: Color(0xff095300),
  ...
  static ColorScheme lightMediumContrastScheme() {
    return const ColorScheme(
      ...
      secondary: Color(0xff064000),
      onSecondary: Color(0xffffffff),
      secondaryContainer: Color(0xff147f00),
      onSecondaryContainer: Color(0xffffffff),
      tertiary: Color(0xff000000),
      onTertiary: Color(0xffffffff),
      tertiaryContainer: Color(0xff1c1b1b),
      onTertiaryContainer: Color(0xffa8a6a6),
      ...
      secondaryFixed: Color(0xff147f00),
      onSecondaryFixed: Color(0xffffffff),
      secondaryFixedDim: Color(0xff0d6300),
  ...
  static ColorScheme lightHighContrastScheme() {
    return const ColorScheme(
      ...
      secondary: Color(0xff043400),
      onSecondary: Color(0xffffffff),
      secondaryContainer: Color(0xff0a5600),
      onSecondaryContainer: Color(0xffffffff),
      tertiary: Color(0xff000000),
      onTertiary: Color(0xffffffff),
      tertiaryContainer: Color(0xff1c1b1b),
      onTertiaryContainer: Color(0xffd2d0cf),
      ...
      onPrimaryFixedVariant: Color(0xffffffff),
      secondaryFixed: Color(0xff0a5600),
      onSecondaryFixed: Color(0xffffffff),
      secondaryFixedDim: Color(0xff053c00),
      onSecondaryFixedVariant: Color(0xffffffff),
  ...
  static ColorScheme darkScheme() {
    return const ColorScheme(
      ...
      onTertiaryContainer: Color(0xff807f7e),
  ...
  static ColorScheme darkMediumContrastScheme() {
    return const ColorScheme(
      ...
      onSecondary: Color(0xff053900),
      secondaryContainer: Color(0xff39ff14),
      onSecondaryContainer: Color(0xff095100),
      ...
      secondaryFixedDim: Color(0xff2ae500),
      onSecondaryFixedVariant: Color(0xff064000),
      tertiaryFixed: Color(0xffe5e2e1),
  ...
  static ColorScheme darkHighContrastScheme() {
    return const ColorScheme(
      ...
      secondaryContainer: Color(0xff39ff14),
      onSecondaryContainer: Color(0xff032e00),
      tertiary: Color(0xfff2efef),
      onTertiary: Color(0xff000000),
      tertiaryContainer: Color(0xffc4c2c1),
